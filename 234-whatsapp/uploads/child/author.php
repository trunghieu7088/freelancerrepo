        ...
        <div class="row user-statistic highlight">
            <div class="col-md-5 col-xs-12 user-info">
                ...
                <ul>
                    ...
                    <li itemprop="university" class="email">
                     ...
                     <li itemprop="level_education" class="email">
                      ...
                      <li itemprop="job_role" class="email">
                ...
                <div class="row paginations home">
                    <div class="col-md-12">
                        ...
                        global $wp_rewrite;
                            ...
                            $member_url = get_author_posts_url($user_id);

                            if( !$wp_rewrite->using_permalinks()){
                                $base = $member_url."&page=%#%";
                            } else {
                                $base = $member_url."?page=%#%";
                            }
