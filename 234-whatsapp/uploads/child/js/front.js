		...
		doRegister: function(event) {
			...
			this.register_validator = $("form#signup_form").validate({
				...
				messages: {
					...
					university:
					{
						required: 'Please fill out all fields required',
					}
					//end
				}
			});
			...
			var form 	 = $(event.currentTarget),
				...
				//custom code here
				university = form.find('input#university').val(),
				level_education = form.find('select#level_education').val(),
				//end
				button   = form.find('input.btn-submit'),
	...
	Views.EditProfileModal = AE.Views.Modal_Box.extend({
		...
		saveProfile: function(event) {
			...
			var form = $(event.currentTarget),
				...
				university = form.find('input#university').val(),
				level_education = form.find('select#level_education').val(),
				job_role = form.find('select#job_role').val(),
				//end
				data = form.serializeObject(),
				view = this;
