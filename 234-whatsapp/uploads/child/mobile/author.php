            ...
            if(isset($_GET['edit']) && $_GET['edit'] == 'change-profile'){ ?>
                ...
                <form id="change_profile"  class="form_update" action="">
                    <div class="col-md-12 change_profile">
                        ...
                        <div class="form-post">                          
                            <label class="form-title"><?php _e("University", ET_DOMAIN) ?></label>                           
                            <input type="text" value="<?php echo $user->university;?>" class="submit-input" maxlength="60" id="university" name="university">
                        </div>

                        <div class="form-post">
                             <label class="form-title"><?php _e("Level of Education", ET_DOMAIN) ?></label>
                             <br> 
                        <?php 
                        //custom code here
                        $level_education=get_user_meta(get_current_user_id(),'level_education',true);
                        ?>
                        <select style="width: 100%;padding:10px;color:#8b97b1;background-color:#fff;border: 1px solid rgba(140,151,178,.4) !important;border-radius: 5px;" id="level_education" name="level_education" class="categories-select chosen-select">
                        ...
                        <div class="form-post">
                             <label class="form-title"><?php _e("Registering as", ET_DOMAIN) ?></label>
                             <br>
                            <?php 
                        //custom code here
                        ...
                        ?>
                             <select style="width: 100%;padding:10px;color:#8b97b1;background-color:#fff;border: 1px solid rgba(140,151,178,.4) !important;border-radius: 5px;" id="job_role" name="job_role" class="categories-select chosen-select">
                        ...
                        <div class="form-post">
                            ...
                            <label for="show_email"><?php _e('Make this email public.',ET_DOMAIN);?></label>
                        </div>
                        <div class="form-post">
