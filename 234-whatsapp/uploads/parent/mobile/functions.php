...
function qa_mobile_scripts_styles(){
	/* ==== PRINT SCRIPTS ==== */
	wp_enqueue_script('mobile-front', 	get_stylesheet_directory_uri() . '/mobile/js/front.js', array('jquery', 'underscore', 'backbone', 'site-functions', 'appengine'));
	wp_enqueue_script('mobile-pumping', 		TEMPLATEURL . '/js/pumping.js', array('jquery', 'underscore', 'backbone', 'appengine', 'mobile-front'));
	wp_enqueue_script('mouseweel', 		TEMPLATEURL . '/mobile/js/jquery.mouseweel.js', array('jquery'), ET_VERSION);
	wp_enqueue_script('mobile-script', 	TEMPLATEURL . '/mobile/js/script-mobile.js', array('jquery'), ET_VERSION);
	wp_enqueue_script('mobile-script', 	TEMPLATEURL . '/js/libs/adjector.js', array('jquery'), ET_VERSION);

	wp_enqueue_script('date-picker-moment', 		TEMPLATEURL . '/mobile/js/moment.min.js', array('jquery', 'underscore', 'backbone', 'site-functions'), ET_VERSION);
	wp_enqueue_script('date-picker', 		TEMPLATEURL . '/mobile/js/bootstrap-datetimepicker.min.js', array('jquery', 'underscore', 'backbone', 'site-functions','date-picker-moment'), ET_VERSION);

	//localize scripts
	wp_localize_script( 'mobile-front', 'qa_front', qa_static_texts() );

	if(is_singular( 'question' )){
		wp_enqueue_script('mobile-single-question', 	TEMPLATEURL . '/mobile/js/single-question.js', array('jquery', 'underscore', 'backbone', 'site-functions','mobile-front'), ET_VERSION);
	}
	if(is_singular( 'answer' )){
		wp_enqueue_script('mobile-single-answer', 	TEMPLATEURL . '/mobile/js/single-answer.js', array('jquery', 'underscore', 'backbone', 'site-functions','mobile-front'), ET_VERSION);
	}
	if(is_singular( 'poll' )){
		wp_enqueue_script('mobile-single-poll', 	TEMPLATEURL . '/mobile/js/single-poll.js', array('jquery', 'underscore', 'backbone', 'site-functions','mobile-front'), ET_VERSION);
	}
	/* ==== PRINT STYLES ==== */
	wp_enqueue_style( 'mobile-style', 	TEMPLATEURL . '/mobile/css/main.css', array('bootstrap'), ET_VERSION );
	wp_enqueue_style( 'date-picker-style', 	TEMPLATEURL . '/mobile/css/bootstrap-datetimepicker.min.css', array('bootstrap'), ET_VERSION );
}
