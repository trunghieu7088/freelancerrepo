...
<head>
	...
	<title id="head-title"><?php wp_title( '|', true, 'right' ); ?></title>
    ...
    ?>
<?php //custom code realtime here ?>
	<script type="text/javascript">
let presencechannel=false;
let pusher=false;
...
if(is_home())
{	
	$check_page='target="_self"';
}
else
{	
	$check_page='target="_blank"';	
}
?>
<body <?php body_class( $body_class ); ?>>

	<iframe src="<?php echo get_stylesheet_directory_uri().'/sound/silence.mp3'; ?>" allow="autoplay" style="display:none" type="audio/mp3" id="framesound"> 
	</iframe>

	<audio id="playerSoundMessage">
    	<source src="<?php echo get_stylesheet_directory_uri().'/sound/message.wav'; ?>">
	</audio>

	<audio id="playerSoundNoti">
    	<source src="<?php echo get_stylesheet_directory_uri().'/sound/notification.wav'; ?>">
	</audio>
