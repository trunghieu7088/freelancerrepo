...
if  ( $current_user_is_partner  || $admin_view_chat ) : ?>
    <div class="conversation-form microjobengine\template\mjob-order\conversation.php line15">
        <div class="inner-conversation-form"><?php
                ...
                echo '</div>';
                // End load more link
                echo '<ul class="list-conversation" id="orderMessageList">';
  ...
  $latest_reply=get_post_meta($mjob_order->ID,'latest_reply',true);    
    if($latest_reply)
    {
    ...
    $conversation_custom_status=get_post_meta($mjob_order->ID,$last_reply_to_user.'_conversation_status',true);
