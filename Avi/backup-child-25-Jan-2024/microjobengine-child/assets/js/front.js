...
(function($, Models, Collections, Views) {
    ...
    $(document).ready(function() {
         ...
         */
        //custom code recruit them archive-requesst-item in className.
        var mjobItem = Views.PostItem.extend({
            tagName: 'li',
            className: 'col-lg-4 col-md-4 col-sm-6 col-xs-6 col-mobile-12 item_js_handle archive-requesst-item',
