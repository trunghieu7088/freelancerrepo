            ...
            nextStep: function(event) {
                ...
                if(view.form_validator.form()) {
                    view.model = new Models.mJobUser({
                        //custom code here
                        custom_role: $("input[name='custom_role']:checked").val(),
                        //end
                    ...
                    this.model.save('', '', {
                        success: function (result, resp, jqXHR) {
                            if( resp.success ) {
                                ...
                                //custom code
                                view.signUpModal.$el.find('form').append('<input type="hidden" id="custom_role" name="custom_role" value="'+ view.model.get('custom_role') +'"/>');
                                //end 
                                // Open modal
