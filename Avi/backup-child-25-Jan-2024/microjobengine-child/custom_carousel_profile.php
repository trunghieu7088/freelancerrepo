...
function custom_carousel_slider_init()
{
    ...
    <div class="block-items carousel-profile">
        <div class="container">
            <p class="block-title float-center"><?php echo $carousel_profile_title; ?></p>      
                        ...
                        if(isset($carousel_profile_array) && !empty($carousel_profile_array)) :
                            foreach($carousel_profile_array as $profile_item): ?>
                                <?php 
                                    ...
                                    $expertise=get_term(get_post_meta($mjob_profile->ID,'expertise',true),'mjob_category');
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12 swiper-slide">
                                    <div class="carousel-item" style="<?php if($slider_item_bg_color) echo 'background-color:'.$slider_item_bg_color; ?>">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 carousel-right">
                                            ...
                                            <p class="carousel-profile-profession"><span style="<?php if($profession_title_text_color) echo 'color:'.$profession_title_text_color.';'; if($profession_title_bg_color) echo 'background-color:'.$profession_title_bg_color.';'; ?>"><i class="fa fa-briefcase"></i> <?php echo $expertiseShow; ?></span></p>
           ...
           <!-- <img src="<?php echo get_stylesheet_directory_uri().'/assets/img/new-three-dots.png';  ?>" class="profile-next-icon-css" name="profile_nextslidep" id="profile_nextslidep" > -->
           ...
           <!-- <img src="<?php echo get_stylesheet_directory_uri().'/assets/img/previous-icon-blue.png';  ?>" class="profile-previous-icon-css" name="profile_prevslidep" id="profile_prevslidep" >                -->                    
              <!--        <img src="<?php echo get_stylesheet_directory_uri().'/assets/img/new-three-dots.png';  ?>" class="profile-previous-icon-css" name="profile_prevslidep" id="profile_prevslidep" > -->
