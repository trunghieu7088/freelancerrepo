...
?>          
			...
			<div class="link-post-services">
                <a href="<?php echo et_get_page_link('post-recruit');?>">
                    <?php _e('Post a hire', 'enginethemes'); ?>
			...
			if (is_mje_submit_page()) {
				$post_link = '#';
				if (is_page_template('page-post-recruit.php'))
				{
					$post_link = et_get_page_link('post-service');
				}
			} else {
