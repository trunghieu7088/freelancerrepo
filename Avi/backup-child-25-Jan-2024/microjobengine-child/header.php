...
<head>
    ...
    <?php if(is_user_logged_in() && !mje_is_user_active(get_current_user_id())): ?>
        <script type="text/javascript">
            (function ($) {
                $(document).ready(function() 
                {
                    toastr.options.closeButton = true;
                    toastr.warning('Please confirm your email to get started', 'Email Confirmation', {timeOut: 5000})
                });
            })(jQuery);
