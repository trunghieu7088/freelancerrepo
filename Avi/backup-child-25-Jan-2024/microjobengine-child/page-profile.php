...
//custom code custom role
$custom_user = get_userdata( $user_ID );
                    ...
                    <div class="block-billing" style="margin-top:0px !important;margin-bottom: 30px;">   
                        ...
                        <ul>                            
                           <!-- <li>
                                    ...
                                    <div id="profession" class="info-content">
                                        <div class="text-content" data-type="input" data-name="profession" data-id="#profession"><p><?php echo $profession ?></p></div>
                                    </div>
                            </li> -->
                            <?php if($custom_role!='Client') : ?>   
                            <li>
                                <div class="cate-title"><?php _e('Expertise', 'enginethemes'); ?></div>
                            ...
                            <?php endif; ?>  
                              <!-- custom code role -->
                            <li>
                                <div class="cate-title" style="line-height:10px !important;"><?php _e('User Type', 'enginethemes'); ?></div>
                                <div id="customrole" class="info-content">
                                    <span><?php echo $custom_role; ?></span>
                                </div>
                            </li> 
