<?php
   ...
   function custom_homepage_slider_init()
   {
    ob_start();
    ?>
     <div class="block-items custom-gig-slider">
            <div class="container">
                <p class="block-title float-center" style="margin-bottom:30px !important;"></p>
            ...
            <div class="view-all-jobs-wrap mje-home-default" style="padding-bottom:25px !important;margin-bottom:10px;">
                <a class="btn-order waves-effect waves-light btn-submit mjob-order-action" style="padding:10px 40px;" href="<?php echo get_post_type_archive_link('mjob_post'); ?>">
                    <?php _e('View all gigs', 'enginethemes');?>
                </a>
            </div>
