...
// Paypal account data
//custom code here
$paypal_email = isset($user_data->payment_info['paypal']['paypal_email']) ? $user_data->payment_info['paypal']['paypal_email'] : '';
$paypal_first_name= isset($user_data->payment_info['paypal']['paypal_first_name']) ? $user_data->payment_info['paypal']['paypal_first_name'] : '';
$paypal_middle_name = isset($user_data->payment_info['paypal']['paypal_middle_name']) ? $user_data->payment_info['paypal']['paypal_middle_name'] : '';
$paypal_last_name = isset($user_data->payment_info['paypal']['paypal_last_name']) ? $user_data->payment_info['paypal']['paypal_last_name'] : '';
$paypal_custom_address = isset($user_data->payment_info['paypal']['paypal_custom_address']) ? $user_data->payment_info['paypal']['paypal_custom_address'] : '';
$paypal_custom_tel = isset($user_data->payment_info['paypal']['paypal_custom_tel']) ? $user_data->payment_info['paypal']['paypal_custom_tel'] : '';
//end custom code
get_header();
?>
<div id="content">
                            ...
                            <div id="paypalAccountForm">
                                <form class="et-form">
                                    ...
                                    <div class="row clearfix" style="margin-bottom:40px;">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                                            <div class="input-group">
                                                <label for="paypal_first_name"><?php _e('First name', 'enginethemes');?></label>
                                                <input type="text" name="paypal_first_name" id="paypal_first_name" placeholder="" value="<?php echo $paypal_first_name; ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                                            <div class="input-group">
                                                <label for="paypal_middle_name"><?php _e('Middle name', 'enginethemes');?></label>
                                                <input type="text" name="paypal_middle_name" id="paypal_middle_name" placeholder="" value="<?php echo $paypal_middle_name; ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                                            <div class="input-group">
                                                <label for="paypal_last_name"><?php _e('Last name', 'enginethemes');?></label>
                                                <input type="text" name="paypal_last_name" id="paypal_last_name" placeholder="" value="<?php echo $paypal_last_name; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="input-group">
                                            <label for="paypal_custom_address"><?php _e('Address', 'enginethemes');?></label>
                                            <input type="text" name="paypal_custom_address" id="paypal_custom_address" placeholder=""  value="<?php echo $paypal_custom_address; ?>">
                                        </div>
                                    </div>

                                    <div class="form-group clearfix">
                                        <div class="input-group">
                                            <label for="paypal_custom_tel"><?php _e('Tel', 'enginethemes');?></label>
                                            <input type="text" name="paypal_custom_tel" id="paypal_custom_tel" placeholder="Ex: +84778865321"  value="<?php echo $paypal_custom_tel; ?>">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group clearfix">
                                        <div class="input-group">
                                            <label for="paypal_email"><?php _e('Paypal Email', 'enginethemes');?></label>
