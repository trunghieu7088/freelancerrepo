                        ...
                        <div class="checkbox">
                            ...
                            <label>
                                ...
                                <input type="checkbox" name="term_privacy" id="term_privacy"><span class="tos-text"><?php _e('I accept with the', 'enginethemes'); ?>
                                  <a href="<?php echo site_url('/allgemeine-geschaeftsbedingungen/'); ?>" target="_blank"><?php _e('terms and conditions', 'enginethemes'); ?></a> und 
                                    <a href="<?php echo site_url('/zahlungsbedingungen/'); ?>" target="_blank">Zahlungsbedingungen</a>
