                             ...
                             <li style="padding-left:30px;margin-bottom:25px;">
                                 ...
                                 <div class="cate-title">UBO Verification 
                                    ...
                                    <?php if($seller_type == 'enterprise') : ?>
                                        ...
                                        <div class="text-content" data-type="input" data-name="UBO_verification" data-id="#UBO_verification">
                                            <p><?php echo $UBO_verification; ?></p>
                                        </div>
                                    </div>
                                        <?php else : ?>
                                 ...
                                 <div class="cate-title">Company Extract
                                    ...
                                    <?php if($seller_type == 'enterprise') : ?>
                                        ...
                                        <div class="text-content" data-type="input"  data-name="company_extract" data-id="#company_extract">
                                            <p><?php echo $company_extract; ?></p>
                                        </div>
                                    </div>
                                        <?php else : ?>
                                             <div style="background-color:#ddd;width:30%;height:30px;border-radius:5px;" id="company_extract" class="info-content"> 
                                             </div>
                                    <?php endif ; ?>
                                    ...
                                    <div class="textcontent">
                                         <?php
                                           ...
                                           <span class="text-warning text-uppercase"> No information</span>
                                              &nbsp;&nbsp;&nbsp;&nbsp;
                                               <a href="<?php echo site_url('register-seller-page'); ?>">Add</a>
                                           </strong>
                                           </p>
                                             <?php } else { ?>
                                        <p>
                                            <span class="text-info">
                                                <strong><?php echo $phone_number; ?> </strong>
                                                 &nbsp;&nbsp;&nbsp;&nbsp;
                                                 <a href="#"  data-toggle="modal" data-target="#testModal">Update</a>
                                            </span>
