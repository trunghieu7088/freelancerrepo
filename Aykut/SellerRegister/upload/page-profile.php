                       ...
                       <!-- <p class="title"><?php // _e('Verkäuferstatus', 'enginethemes'); ?></p> -->
                        ...
                        <div class="block-payment" style="margin-bottom:50px;margin-top:30px;">
                            ...
                            <li style="margin-bottom:25px;">
                                <div class="cate-title">Registered Seller</div>
                        ...
                        <?php } ?>
                             <li style="margin-bottom:25px;">
                                <div class="cate-title">TradingForm</div>
                                <div class="info-content">           
                                <strong>
                                <?php 
                        ...
                        <ul>
                            ...
                            ?> 
                            <li>
                                <div class="cate-title"><?php _e('Verified Seller (yes/no)', 'enginethemes'); ?></div>
                           ...
                           <div class="block-billing" style="margin-top:30px !important;">
                            <ul>
                                <li>
                                    <div class="cate-title" style="padding-top:10px;">
                                        <?php _e('VAT or Tax Number', 'enginethemes'); ?>                                            
                                    </div>
