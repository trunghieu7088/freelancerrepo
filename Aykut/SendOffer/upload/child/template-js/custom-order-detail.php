<script type="text/template" class="box-content-custom-order">
    <div class="outer-detail-custom">
            ...
            <div class="block-text custom-offer-new-code">
                   <div class="deadline"><p><?php _e('Thema', 'enginethemes') ?><span>{{= topic }} </span></p></div>
                   <br> 
                    <div class="deadline"><p><?php _e('Art der Arbeit', 'enginethemes') ?><strong><span>{{= kindwork }} </span></strong></p></div>
                 <div class="deadline"><p><?php _e('Seitenanzahl', 'enginethemes') ?><span>{{= amountpage }} </span></p></div>
                 <br>
            ...
            <div class="block-text">
				<# if (is_offer == true) { #>
					<# if(post_author == currentUser.data.ID) { #>
                        <p class="title offertitle"><?php _e('seller\'s offer', 'enginethemes' ) ?></p>
                    <# } else { #>
                        <p class="title offertitle"><?php _e('your offer', 'enginethemes' ) ?></p>
                    <# } #>
				<# } #>
					
                <div class="deadline"><p><?php _e('Thema', 'enginethemes') ?><span>{{= topic_offer }} </span></p></div>
                      <br>                
                 <div class="deadline"><p><?php _e('Art der Arbeit', 'enginethemes') ?><strong><span>{{= kindwork_offer }} </span></strong></p></div>
                 <div class="deadline"><p><?php _e('Seitenanzahl', 'enginethemes') ?><span>{{= amountpage_offer }} </span></p></div>
                 <br>
