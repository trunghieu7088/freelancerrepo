    ...
    public function after_send_message($message, $request) {
        ...
        if(isset($message['data']) && !empty($message['data'])) {
            ...
            if($message_data->type == 'custom_order') {
                  ...
                  //custom code here :
                  //add custom fields to custom orders

                update_post_meta($message_data->ID, 'topic', $request['topic']);
                update_post_meta($message_data->ID, 'kindwork', $request['kindwork']);
                update_post_meta($message_data->ID, 'amountpage', $request['amountpage']);
               //end custom 
            ...
            if($message_data->type == 'offer') {
                ...
                if(isset($request['custom_order_id']) && $request['custom_order_id']=='none')
                {
                    $auto_custom_order=array('post_title'=>'auto custom order',
                        'post_content'=>'auto custom order',
                   ...
                   update_post_meta($auto_custom_order_id,'custom_order_status','offer_sent');
                    ...
                    //fix bug 
                    update_post_meta($auto_custom_order_id,'custom_order_mjob',$request['mjob']);
