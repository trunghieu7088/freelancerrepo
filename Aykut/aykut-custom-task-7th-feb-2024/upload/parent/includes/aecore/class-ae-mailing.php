...

{
    ...
    function get_mail_header() {
        ...
        //custom code around here
        $logo_url ='https://meet-your-writer.com/wp-content/uploads/2023/07/image_2023_07_03T08_34_33_506Z.png';
        ...
        $mail_header = '<html>
                        ...
                        <body style="font-family: Arial, sans-serif;font-size: 0.9em;margin: 0; padding: 0; color: #ffffff;">

                        <div style="margin: 0px auto; width:600px; border: 1px solid ' . '#5E8D93'. '">

                            <table width="100%" cellspacing="0" cellpadding="0">

                            <tr style="background: ' .  '#5E8D93' . '; height: 63px; vertical-align: middle;">

                                <td style="padding: 10px 5px 10px 20px; width: 20%;">

                                    <img style="max-height: 100px;width:30%;" src="' . $logo_url . '" alt="' . get_option('blogname') . '">
    ...
    function get_mail_footer() {
        ...
        $site_copyright = apply_filters('get_copyright', get_theme_mod('site_copyright'));
                            ...
                            <td colspan="2" style="background: ' . $customize['background'] . '; padding: 10px 20px; color: #666;">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: top; text-align: left; width: 50%;">' . $site_copyright . '</td>
