(function($, Views, Models, Collections){
    ...
    $(document).ready(function() {
        ...
        $.validator.addMethod("customPasword1", function(value, element) {
          ...
          $.validator.addMethod("customPasword2", function(value, element) {
            
            return this.optional(element) || /(?=.*[A-Z])/.test(value);
            
          }, "Password requires at least 1 uppercase letter");
          
          $.validator.addMethod("customPasword3", function(value, element) {
            
            return this.optional(element) || /(?=.*\d)/.test(value);

          }, "Password requires at least 1 digit.");

          $.validator.addMethod("customPasword4", function(value, element) {
