...
(function(AE, $, Backbone, Views, Models, Collections) {
    ...
    AE.Views.Modal_Box = Backbone.View.extend({
        ...
        openModal: function() {
            ...
            //this.$el.modal('show');
            this.$el.modal({backdrop: "static"},'show');
    ...
    */
    ...
    Views.BlockControl = Backbone.Marionette.View.extend({
        ...
        resetTermLink: function (event){
            ...
            console.log(ae_globals.term_link);
        ...
        customFilter: function(event) {
            ...
            if (name !== 'undefined') {
                ...
                //custom code update title 21th march 2024
                $(document).prop('title', $target.text());                
                //end custom code
