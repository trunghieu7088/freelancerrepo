...
$profile_description= get_post_meta($profile_id,'profile_description',true) ? get_post_meta($profile_id,'profile_description',true) : '';
//new code 18th Oct 2023
$profile_university=get_post_meta($profile_id,'university',true) ? get_post_meta($profile_id,'university',true) : '';
$profile_major=get_post_meta($profile_id,'major',true) ? get_post_meta($profile_id,'major',true) : '';
$profile_graduation_year=get_post_meta($profile_id,'graduation_year',true) ? get_post_meta($profile_id,'graduation_year',true) : '';

$profile_academic_degree=get_post_meta($profile_id,'academic_degree',true) ? get_post_meta($profile_id,'academic_degree',true) : '';
if($profile_academic_degree)
{
  $profile_academic_degree_info=get_term( $profile_academic_degree, 'degree' )->term_id;
   $degree_selected=true;
}
else
{
  $profile_academic_degree_info=0;
            	 ...
            	 <div class="form-group clearfix">
                    ...
                    ae_tax_dropdown('degree',
                    	array('attr' => 'data-chosen-width="100%" data-chosen-disable-search=""  data-placeholder="' . __("Choose degree", 'enginethemes') . '"',
                    		...
                    		'name' => 'degree',
                    		'show_option_all' => false,
                        'selected' => $profile_academic_degree_info,
                    	)
                    );?>
                			</div>
            		</div>
            	...
            	<div class="form-group clearfix mje-mjob-title-field" style="margin-top:20px;">
            		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 category-area">
			            <div class="input-group">
			                ...
			                <input required="required" type="text" class="input-full" name="major" id="major" value="<?php echo $profile_major;?>">
			            </div>
		        	</div>
		        </div>
		        ...
		        <div class="form-group clearfix mje-mjob-title-field" style="margin-top:20px;">
		        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 category-area">
			            <div class="input-group">
			                ...
			                <input type="text" class="input-item input-full" id="university" name="university" value="<?php echo $profile_university;?>">
			            </div>
			        </div>
		        </div>
		        ...
		        <div class="form-group clearfix mje-mjob-des-field" style="margin-bottom:40px;">
		        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 category-area">
			            <div class="input-group">
			                ...
			                <?php wp_editor($profile_description, 'customdescription', ae_editor_settings());?>
			            </div>
        			</div>
       			 </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    function AddSelectText()
    {
      ...
      var auto_set_value_degree='<?php echo $degree_selected;  ?>';  
      if(auto_set_value_degree==false || auto_set_value_degree=='false')
      {
