...
<div class="block-intro">
    <div class="container">
        ...
        <div class="load-more float-center">
            <a href="https://meet-your-writer.com/ghostwriter-buchen-2/" class="hvr-wobble-vertical"><?php _e('FIND OUT MORE', 'enginethemes'); ?><i class="fa fa-angle-right"></i></a>
                <!--this was before the href Value-->
                <?php /*echo $about_link;*/ ?>
        </div>
    </div>
</div>