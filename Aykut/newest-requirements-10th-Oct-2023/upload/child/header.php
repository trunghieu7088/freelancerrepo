...
<head>
	...
	<!--custom pinterest key here -->
	<meta name="p:domain_verify" content="9682236fe504ad406d194c858598aff6"/>
	<!-- end -->
		<!--custom code -->
...
(function ($) {   
  $(document).ready(function () { 
  	var labelText= $(".outer-form .text").text();
  	$(".outer-form").click(function(){
  		$('.text-search-home').focus();
		$(".outer-form .text").text('');
  	});

	$(".outer-form input").focusout(function(){  		
		  $(".outer-form .text").text(labelText);
  	});
...
<?php wp_nav_menu( array( 'theme_location' => 'et_header_standard' ) ); ?>
<?php
