...
<div class="block-statistic">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="hvr-wobble-horizontal"><a href="<?php echo et_get_page_link('settings') ?>" style="text-transform: none !important;"><?php _e('Einstellungen für Abonnenten', 'enginethemes'); ?></a></li>

            <li class="hvr-wobble-horizontal"><a href="<?php echo et_get_page_link('payment-method') ?>"><?php _e('Payment method', 'enginethemes'); ?></a></li>

            <li class="hvr-wobble-horizontal"><a href="<?php echo et_get_page_link('change-password') ?>" style="text-transform: none !important;"><?php _e('Passwort ändern', 'enginethemes'); ?></a></li>
