    ...
    <div class="project-detail-info">
        <div class="row">
            <div class="col-lg-8 col-md-7">
                <h1 class="project-detail-title"><?php the_title(); 
                 //custom code here
                	if(get_post_meta($post->ID ,'custom_extra_option',true)=='urgent')
                	{
                		 echo '<span style="margin-left:10px;" class="label label-danger">'.get_option('urgentlabel').'</span>';
                	}
                	if(get_post_meta($post->ID ,'private_extra_option',true)=='private')
                	{
                		 echo '<span style="margin-left:10px;" class="label label-warning">'.get_option('privatelabel').'</span>';
                	}
                	//end
