			...
			*/
            ...
            <div class="module module-edit education">
				...
				<div class="cv-show-area">					
					<a href="<?php echo $cv_link; ?>" download><i class="fa fa-download" aria-hidden="true"></i> Download CV File</a>													
				</div>
				<?php endif; ?>
                ...
                <div class="edu-skill cnt" id="cv-upload-container" name="cv-upload-container">
				   	<?php if(!$cv_link) : ?>
						<p>You can upload your custom cv file here</p>
					<?php else: ?>
						<p>When you upload new file, it will replace the current file</p>
					<?php endif; ?>
					...
					<a href="javascript:void(0)" id="custom-upload-pdf-btn" name="custom-upload-pdf-btn" class="btn-custom-upload-pdf"><i class="fa fa-upload" aria-hidden="true"></i> Upload File</a> 
                </div>
				<?php endif; ?>
            </div>
            <!-- end custom code -->
