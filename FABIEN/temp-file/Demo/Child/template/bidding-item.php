            ...
            <div class="col-md-8 col-sm-12">
                <div class="col-free-bidding">
                    ...
                    <p><?php echo $convert->author_country; ?></p>
                     ...
                     <p style="display:inline-block;font-size:16px;font-family:arial;color:#fff;" class="label label-info">Rank : <?php echo get_user_meta($convert->post_author,'custom_rank_order',true); ?></p>       
