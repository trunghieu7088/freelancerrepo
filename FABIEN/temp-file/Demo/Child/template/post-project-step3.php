    ...
    <div class="fre-post-project-box">
        <form class="post" role="form">
            ...
            <div class="step-post-project" id="fre-post-project" style="padding-right: 0px !important;">
                     ...
                     <div class="row text-center" style="">
                       <?php 
                        ...
                        foreach($parent_categories_block as $item)
                        {
                            ...
                            echo ' <div class="col-sm-3 custom-image-wrapper" style="margin-top:15px;margin-bottom:15px;max-height:180px !important;">';
               ...
               <input type="button" class="fre-btn" style="margin-bottom: 10px;" value="Next" id="next-to-subcategories">
            </div>
               <!-- end -->
