...
class ET_Admin extends AE_Base {
	...
	function admin_setup() {
		...
		//custom code for ranking system
		$bid_plan_array=array('numberposts'=> -1,'post_type'=>'bid_plan','post_status'=>'publish');
		$bid_plan_of_freelancer=get_posts($bid_plan_array);	
	
					foreach($bid_plan_of_freelancer as $bid_plan_item)
					{
						$bid_plan_option_for_rank[]=array(
							'id'      => 'subcription_rank_condition_'.$bid_plan_item->ID,
							'type'    => 'text',
							'title'   => __( $bid_plan_item->post_title, ET_DOMAIN ),							
							'label'	 => __( $bid_plan_item->post_title.' - Rank Point', ET_DOMAIN ),					
							'name'        => 'subcription_rank_condition_'.$bid_plan_item->ID,
							'default' 	  => '10',
							'placeholder' => __( "10", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
						);
					}	

				$sections['ranking-settings'] = array(
			'args'   => array(
				'title' => __( "Ranking System", ET_DOMAIN ),
				'id'    => 'ranking-settings',
				'icon'  => 'y',
				'class' => ''
		),
			'groups' => array(
				...
				// make a bid
					array(
					'args' => array(
						'title' => __( "Submit an offer option", ET_DOMAIN ),
						'id'    => 'make_bid_rank_settings',
						'class' => '',
						'desc'  => __( "Set condition and rank point <br> For example : The users will get 10 rank points when he submit offers", ET_DOMAIN )
					),

					'fields' => array(
						array(
							'id'      => 'make_bid_rank_condition',
							'type'    => 'text',
							'title'   => __( "Submit an offer", ET_DOMAIN ),							
							'label'	 => __( "Submit an offer", ET_DOMAIN ),					
							'name'        => 'make_bid_rank_condition',
							'default' 	  => '1',
							'placeholder' => __( "1", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
						...
						array(
							'id'      => 'make_bid_rank_points',
							'type'    => 'text',
							'title'   => __( "Rank Points", ET_DOMAIN ),							
							'label'	 => __( "Rank Points", ET_DOMAIN ),					
							'name'        => 'make_bid_rank_points',
							'default' 	  => '10',
							'placeholder' => __( "10", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
				...
				// rating of review option
					array(
					'args' => array(
						'title' => __( "Rating of reivew option", ET_DOMAIN ),
						'id'    => 'rating_of_reviews_rank_settings',
						'class' => '',
						'desc'  => __( "Set condition and rank point <br> For example : The users will get 10 rank points when he get 10 rating of review", ET_DOMAIN )
					),

					'fields' => array(
						array(
							'id'      => 'rating_of_reviews_rank_condition',
							'type'    => 'text',
							'title'   => __( "Rating of view", ET_DOMAIN ),							
							'label'	 => __( "Rating of view", ET_DOMAIN ),					
							'name'        => 'rating_of_reviews_rank_condition',
							'default' 	  => '10',
							'placeholder' => __( "10", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
						...
						array(
							'id'      => 'rating_of_reviews_rank_points',
							'type'    => 'text',
							'title'   => __( "Rank Points", ET_DOMAIN ),							
							'label'	 => __( "Rank Points", ET_DOMAIN ),					
							'name'        => 'rating_of_reviews_rank_points',
							'default' 	  => '10',
							'placeholder' => __( "10", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
				...
				// Number of reivew option
				array(
					'args' => array(
						'title' => __( "Number of reivew option", ET_DOMAIN ),
						'id'    => 'number_of_reviews_rank_settings',
						'class' => '',
						'desc'  => __( "Set condition and rank point <br> For example : The users will get 10 rank points when he get 1 review", ET_DOMAIN )
					),

					'fields' => array(
						array(
							'id'      => 'number_of_reviews_rank_condition',
							'type'    => 'text',
							'title'   => __( "Number of reviews", ET_DOMAIN ),							
							'label'	 => __( "Number of reviews", ET_DOMAIN ),					
							'name'        => 'number_of_reviews_rank_condition',
							'default' 	  => '1',
							'placeholder' => __( "1", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
						...
						array(
							'id'      => 'number_of_reviews_rank_points',
							'type'    => 'text',
							'title'   => __( "Rank Points", ET_DOMAIN ),							
							'label'	 => __( "Rank Points", ET_DOMAIN ),					
							'name'        => 'number_of_reviews_rank_points',
							'default' 	  => '10',
							'placeholder' => __( "10", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
				...
				//Number of notification option

				array(
					'args' => array(
						'title' => __( "Number of notification option", ET_DOMAIN ),
						'id'    => 'number_of_notification_rank_settings',
						'class' => '',
						'desc'  => __( "Set condition and rank point <br> For example : The users will get 10 rank points when he get 1 notification", ET_DOMAIN )
					),

					'fields' => array(
						array(
							'id'      => 'number_of_notification_rank_condition',
							'type'    => 'text',
							'title'   => __( "Number of notification", ET_DOMAIN ),							
							'label'	 => __( "Number of notification", ET_DOMAIN ),					
							'name'        => 'number_of_notification_rank_condition',
							'default' 	  => '10',
							'placeholder' => __( "10", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
						...
						array(
							'id'      => 'number_of_notification_rank_points',
							'type'    => 'text',
							'title'   => __( "Rank Points", ET_DOMAIN ),							
							'label'	 => __( "Rank Points", ET_DOMAIN ),					
							'name'        => 'number_of_notification_rank_points',
							'default' 	  => '1',
							'placeholder' => __( "1", ET_DOMAIN ),
							'class'       => 'option-item bg-grey-input gt_zero'
				...
				array(
					'args' => array(
						'title' => __( "Subcription option", ET_DOMAIN ),
						'id'    => 'subcription_rank_settings',
						'class' => '',
						'desc'  => __( "Set condition and rank point <br> For example : The users will get 10 rank points when he subcribe the plan", ET_DOMAIN )
					),

					'fields' => $bid_plan_option_for_rank,
