                ...
                <div class="project-detail-action">
					...
					if ( is_user_logged_in() ) {
						if ( $user_role == EMPLOYER ) {
								echo '<a rel="nofollow" href="' . et_get_page_link( 'submit-project' ) . '" class="fre-normal-btn primary-bg-color">' . __( 'Publier un projet', ET_DOMAIN ) . '</a>';
						}
						...
						if ( $project_status == 'publish' ) {
							echo '<a rel="nofollow" href="' . et_get_page_link( 'submit-project' ) . '" class="fre-normal-btn primary-bg-color">' . __( 'Publier un projet', ET_DOMAIN ) . '</a>';
							echo '<a rel="nofollow" class="fre-normal-btn primary-bg-color" href="' . et_get_page_link( 'login') . '">' . __( 'Faire une offre', ET_DOMAIN ) . '</a>';
						}
					}
					?>
                </div>
