(function($, Models, Collections, Views) {
    ...
    Views.Profile = Backbone.View.extend({
        ...
        events: {
            ...
            'click span.request-confirm': 'requestConfirmMail',
            ...
            'change .currently-working' : 'currentlyWorkingEvent',
        },
        initialize: function() {
        ...
        currentlyWorkingEvent : function(e){

            var element = $(e.target);
            var form =element.closest('form');

            if ( element.is(':checked') ){
                form.find('.novalidate_if_current').removeClass('error');
            }
        },
                    ...
                    "work_experience[m_to]": {
                        required : {
                            depends: function(element) {
                                ...
                                var current_working = form.find('input[name="work_experience[currently_working]"]');


                                /// var checked_currently_working = $('input[name="work_experience[currently_working]"]',form_).attr('checked'); old version
                                ...
                                if( current_working.is(":checked") ){
                                    ...
                                    $(form_).find(".novalidate_if_current").removeClass('error');
                                    return false;
                                }else {
                                    return true;
                                }
        ...
        saveAvatar: function (envent) {
            ...
            if(processing == 'no'){
                ...
                $.ajax({
                    ...
                    success: function (data, statusText, xhr) {
                        AE.pubsub.trigger('ae:saveAvatar', data);
                        if (data.success) {
                            AE.pubsub.trigger('ae:notification', {
                                msg: data.msg,
                                notice_type: 'success'
