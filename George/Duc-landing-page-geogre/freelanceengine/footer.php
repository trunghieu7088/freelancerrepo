...
if ( is_singular( 'project' ) ) {
	...
	get_template_part( 'template-js/modal', 'bid' ); // modal-bid.php

	get_template_part( 'template-js/modal', 'can-not-bid' ); //modal-can-not-bid.php invite_to_bid or bid_left = 0
