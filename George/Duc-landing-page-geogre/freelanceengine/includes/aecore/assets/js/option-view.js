...
(function(Models, Views, $, Backbone) {
    ...
    Views.Options = Backbone.View.extend({
        events: {
            ...
            'change .dropdown'            : 'multiInputUpdate', // semantic ui
            ...
            'click .js-copy-field': 'actCopyText',
        ...
        actCopyText :function(event){
            ...
            try {
                ...
                var msg = successful ? 'successfully' : 'unsuccessfully'
                    ...
                    var html = '<span class="hide toast-success"><i data-icon="3" class="icon engine-menu-icon icon-3"></i>'+$success+'</span>';
