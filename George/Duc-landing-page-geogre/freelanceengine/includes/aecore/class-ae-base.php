...
if (!class_exists('AE_Base')) {
    class AE_Base
    {
         ...
         * @param $in_footer
         */
        public function add_script($handle, $src, $deps = array() , $ver = ET_VERSION, $in_footer = true) {
        ...
        public function register_script($handle, $src, $deps = array() , $ver = ET_VERSION, $in_footer = true) {
            $scripts = apply_filters(self::FILTER_SCRIPT, array(
                'handle' => $handle,
                'src' => $src,
                'deps' => $deps,
         ...
         * @param $media
         */
        public function add_style($handle, $src = false, $deps = array() , $ver = ET_VERSION, $media = 'all') {
         ...
         * @param $media
         */
        public function register_style($handle, $src = false, $deps = array() , $ver = ET_VERSION, $media = 'all') {
            $style = apply_filters(self::FILTER_STYLE, array(
                'handle' => $handle,
                'src' => $src,
                'deps' => $deps,
