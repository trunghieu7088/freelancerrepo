...
$.fn.dropdown.settings.templates = {
  ...
  dropdown: function(select) {
    var
      ...
      html        = ''
    ;
    html +=  '<i  class="dropdown icon arrow-down"></i>'; // add custom here arrow-down enginethemes
  ...
  label: function(value, text) {
    return text + '<i  data-icon="*" class="delete icon"></i> '; // add custom_here data-icon attribute enginethemes
  },
