...
function ae_social_login_settings($pages)
{
    ...
    $default_roles          = ae_get_social_login_user_roles_default();
    $sections[] = array(
        'args' => array(
        ...
        'groups' => array(
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'social-api',
                    'class' => '',
                    'desc' => __("Follow <a href='https://docs.enginethemes.com/article/527-setup-the-social-login-feature/' target='_blank'> tutorial post</a> to setup social login API.<br /> <p> &nbsp</p>", ET_DOMAIN)
                ),
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'twitter-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Twitter. Go to <a href = 'https://developer.twitter.com/en/apps' target ='_blank'> Twitter Developer </a>", ET_DOMAIN)
                ),
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'facebook-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Facebook. Go to <a href='https://developers.facebook.com/' target='_blank'>Facebook Developer Application</a>", ET_DOMAIN)
                ),
            ...
            array(
                'args' => array(
                    ...
                    'id' => 'google-api',
                    'class' => '',
                    'desc' => __("Enabling this will allow users to log in via Google. Go to <a href='https://console.developers.google.com/' target='_blank'>Google Developer Console</a> ", ET_DOMAIN)
                ),
        ...
        'groups' => array(
            array(
                'args' => array(
                    ...
                    'id' => 'social-connect',
                    'class' => '',
                    'desc' => __("You can create a new page and paste shortcode [social_connect_page] on the content of that page.", ET_DOMAIN)
                ),
            ...
            array(
                ...
                'args' => array(
                    ...
                    'id' => 'user_roles',
                    'class' => '',
                    'desc' => __("Select the user roles that users can choose from after login with social accounts.", ET_DOMAIN)
                ),
