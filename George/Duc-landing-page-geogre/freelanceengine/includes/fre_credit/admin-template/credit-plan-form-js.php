<script type="text/template" id="template_edit_fre_credit_plan">
	<form action="qa-update-badge" class="edit-plan engine-payment-form">
		...
		<div class="form payment-plan">
			...
			<div class="form-item f-left-all clearfix">
				...
				<?php if( is_active_fcp() ){ ?>
				<div class="width33p col-et-6" >
					<div class="label"><?php _e("Money number for this package", ET_DOMAIN); ?></div>
					<input value="{{= et_number_posts }}" class=" bg-grey-input width50p not-empty is-number" type="text" name="et_number_posts" />
