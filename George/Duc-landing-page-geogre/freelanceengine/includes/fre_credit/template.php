...
if( !function_exists('fre_credit_add_profile_tab_content') ){
    ...
    function fre_credit_add_profile_tab_content(){
      ...
      $blance_tab_class = 'active';
      $transaction_tab_class = '';
      $trans_id = isset($_GET['trans_id']) ? $_GET['trans_id'] : 0;
      if($trans_id){
        $blance_tab_class = '';
        $transaction_tab_class = 'active';
      }
        ?>
            ...
            <div class="fre-page-section">
                <div class="container">
                    <div class="fre-credit-wrap">
                        <ul class="fre-tabs">
                            <li class="<?php echo $blance_tab_class;?>"><a data-toggle="tab" href="#fre-credit-balance"><?php _e('Balance',ET_DOMAIN) ?></a></li>
                            <li class="<?php echo $transaction_tab_class;?>"> <a data-toggle="tab" href="#fre-credit-transaction"><?php _e('Transaction',ET_DOMAIN) ?></a></li>
                        </ul>
                        <div class="fre-tab-content">
                            <div id="fre-credit-balance" class="fre-panel-tab <?php echo $blance_tab_class;?>">
                            ...
                            <div id="fre-credit-transaction" class="fre-panel-tab fre-credit-history-wrapper <?php echo $transaction_tab_class;?>">
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="fre-input-field">
                                                    ...
                                                    <select class="fre-chosen-single fre-credit-history-filter-type" >
                                                        ...
                                                        <?php if(is_acti_fre_membership() ){?>
                                                            <option value="subscriber"><?php _e('Subscribe', ET_DOMAIN); ?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
