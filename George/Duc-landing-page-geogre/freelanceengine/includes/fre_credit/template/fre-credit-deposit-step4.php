...
?>
<div id="fre-post-project-2 step-post step-select-pmgt-deposit" class="fre-post-project-step step-wrapper step-post <?php if($bid_id) echo 'active';?> ">
    <?php
    /**
     *@since version 1.2.3
    */
    if( $bid_id ){
        ...
        if( ! is_wp_error( $deposit_info) ){
            ...
            $et_price = round($et_price, 2);

            ?>
            <div class="fre-post-project-box fre-deposit-des">
    ...
    <div class="fre-post-project-box fre-deposit-packages">
        <div class="step-change-package show_select_package">
    ...
    <?php } ?>
    <div class="fre-post-project-box  fre-deposit-pmgt">
                        ...
                        <div id="fre-payment-cash" class="panel-collapse collapse fre-payment-proccess">
                            <div class="fre-payment-cash">
                               <p>
                                ...
                                <strong class="cash-message cast_message_fre_credit"><?php echo $cash_options['cash_message']; ?></strong>
                            </div>
