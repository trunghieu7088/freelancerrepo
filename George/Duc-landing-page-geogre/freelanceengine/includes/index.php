...
require_once dirname( __FILE__ ).'/class-fre-order-v2.php'; // v1.8.19

if(!class_exists('AE_Base')) return;

require_once dirname(__FILE__) . '/escrow/index.php';
if( ! defined('FRE_CREDIT_VERSION')){
	require_once dirname(__FILE__) . '/fre_credit/index.php';
}

require_once dirname(__FILE__) . '/tgm-activation.php';
require_once dirname(__FILE__) . '/admin.php';
require_once dirname(__FILE__) . '/generate_pages_default.php';
...
require_once dirname(__FILE__) . '/functions-v2.php';
...
//require_once dirname( __FILE__ ).'/paypal_subscription/index.php';
require_once dirname(__FILE__) . '/develop_mode.php';
require_once dirname(__FILE__) . '/shortcodes.php';
require_once dirname(__FILE__) . '/fix_paypal.php';
