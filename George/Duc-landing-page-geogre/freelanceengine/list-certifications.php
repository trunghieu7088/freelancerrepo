        ...
        <div class="profile-freelance-certificate">
            ...
            <ul class="freelance-certificate-list">
                <?php if ($is_edit) { ?>
                    ...
                    <li class="freelance-certificate-new-wrap cnt-profile-hide" id="ctn-edit-certification">
                        <div class="freelance-certificate-new">
                            <form class="fre-certificate-form freelance-certification-form" action="" method="post">

                                <div class="fre-input-field">
                                    <input type="text" name="certification[title]" placeholder="<?php _e('The course entitled', ET_DOMAIN) ?>">
                                </div>

                                <div class="fre-input-field">
                                    <input type="text" name="certification[subtitle]" placeholder="<?php _e('Granted by', ET_DOMAIN) ?>">
                                </div>
                                ...
                                <div class="fre-form-btn">
                                    ...
                                    <span class="fre-certificate-close profile-show-edit-tab-btn" data-ctn_edit="fre-empty-certification"><?php _e('Cancel', ET_DOMAIN) ?></span>
                                </div>
                            </form>
                        </div>
                    </li>
                ...
                ?>
                                ...
                                <li class="cnt-profile-hide meta_history_item_<?php echo $certification->meta_id ?>" id="cnt-certification-default-<?php echo $certification->meta_id ?>" style="<?php echo $k + 1 == count($certifications) ? 'border-bottom: 0;padding-bottom: 0;' : '' ?>">
                                    ...
                                    <?php if ($is_edit) { ?>
                                        <div class="freelance-certificate-action">
                                            <a href="javascript:void(0)" class="profile-show-edit-tab-btn" data-ctn_edit="ctn-edit-certification-<?php echo $certification->meta_id ?>">
                                ...
                                <?php if ($is_edit) { ?>
                                    ...
                                    <li class="freelance-certificate-new-wrap cnt-profile-hide meta_history_item_<?php echo $certification->meta_id ?>" id="ctn-edit-certification-<?php echo $certification->meta_id ?>">
                                        <div class="freelance-certificate-new">
                                            <form class="fre-certificate-form freelance-certification-form 123" action="" method="post">

                                                <div class="fre-input-field">
                                                    <input type="text" name="certification[title]" placeholder="<?php _e('The course entitled', ET_DOMAIN) ?>" value="<?php echo $e_value['title'] ?>">
                                                </div>

                                                <div class="fre-input-field">
                                                    <input type="text" name="certification[subtitle]" value="<?php echo $e_value['subtitle'] ?>" placeholder="<?php _e('Granted by', ET_DOMAIN) ?>">
                                                </div>
                                                ...
                                                <!-- End To !-->
                                                <div class="fre-input-field no-margin-bottom">
                                                    <textarea name="certification[content]" id="" cols="30" placeholder="<?php _e('Description (optional)', ET_DOMAIN) ?>" rows="10"><?php echo !empty($e_value['content']) ? $e_value['content'] : '' ?></textarea>
                                                </div>

                                                <input type="hidden" value="<?php echo $certification->meta_id ?>" name="certification[id]">

                                                <div class="fre-form-btn">
                                                    <input type="submit" class="fre-normal-btn btn-submit" name="" value="<?php _e('Save', ET_DOMAIN) ?>">
                                                    <span class="fre-certificate-close profile-show-edit-tab-btn" data-ctn_edit="cnt-certification-default-<?php echo $certification->meta_id ?>"><?php _e('Cancel', ET_DOMAIN) ?></span>
                                                </div>
                                            </form>
                                        </div>
                                    </li>
