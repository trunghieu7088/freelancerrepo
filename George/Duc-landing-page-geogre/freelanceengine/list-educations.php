        ...
        <div class="profile-freelance-education">
                    ...
                    <?php if ($is_edit) { ?>
                        <div class="col-sm-6 col-xs-12">
                            <div class="freelance-education-add">
                                <a href="javascript:void(0)" class="fre-normal-btn-o profile-show-edit-tab-btn" data-ctn_hide="fre-empty-education" data-ctn_edit="ctn-edit-education">
            ...
            <ul class="freelance-education-list">
                <?php if ($is_edit) { ?>
                    ...
                    <li class="freelance-education-new-wrap cnt-profile-hide" id="ctn-edit-education">
                        <div class="freelance-education-new">
                            <form class="fre-education-form freelance-education-form" action="" method="post">

                                <div class="fre-input-field">
                                    <input type="text" name="education[title]" placeholder="<?php _e('Degree', ET_DOMAIN) ?>">
                                </div>

                                <div class="fre-input-field">
                                    <input type="text" name="education[subtitle]" placeholder="<?php _e('School', ET_DOMAIN) ?>">
                                </div>
                                ...
                                <div class="fre-form-btn">
                                    ...
                                    <span class="fre-education-close profile-show-edit-tab-btn" data-ctn_edit="fre-empty-education"><?php _e('Cancel', ET_DOMAIN) ?></span>
                                </div>
                            </form>
                        </div>
                    </li>
                ...
                ?>
                                ...
                                <!-- Box show education-->
                                <li class="cnt-profile-hide meta_history_item_<?php echo $education->meta_id ?>" id="cnt-education-default-<?php echo $education->meta_id ?>" style="<?php echo $k + 1 == count($educations) ? 'border-bottom: 0;padding-bottom: 0;' : '' ?>">
                                    ...
                                    <?php if ($is_edit) { ?>
                                        <div class="freelance-education-action">
                                            <a href="javascript:void(0)" class="profile-show-edit-tab-btn" data-ctn_edit="ctn-edit-education-<?php echo $education->meta_id ?>">
                                ...
                                <?php if ($is_edit) { ?>
                                    <!-- Box edit education-->
                                    <li class="freelance-education-new-wrap cnt-profile-hide meta_history_item_<?php echo $education->meta_id ?>" id="ctn-edit-education-<?php echo $education->meta_id ?>">
                                        <div class="freelance-education-new">
                                            <form class="fre-education-form freelance-education-form" action="" method="post">

                                                <div class="fre-input-field">
                                                    <input type="text" name="education[title]" placeholder="<?php _e('Degree', ET_DOMAIN) ?>" value="<?php echo $e_value['title'] ?>">
                                                </div>

                                                <div class="fre-input-field">
                                                    <input type="text" name="education[subtitle]" value="<?php echo $e_value['subtitle'] ?>" placeholder="<?php _e('School', ET_DOMAIN) ?>">
                                                </div>
                                                ...
                                                <div class="fre-input-field no-margin-bottom">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="fre-input-field">
                                                                <select class="fre-chosen-single" name="education[m_to]" id="">
                                                                    <option value=""><?php _e('Month', ET_DOMAIN) ?></option>
                                                                    <?php
                                                                    for ($i = 1; $i <= 12; $i++) {
                                                                        if (intval($i) < 10) {
                                                ...
                                                <div class="fre-input-field no-margin-bottom">
                                                    <textarea name="education[content]" id="" cols="30" placeholder="<?php _e('Description (optional)', ET_DOMAIN) ?>" rows="10"><?php echo !empty($e_value['content']) ? $e_value['content'] : '' ?></textarea>
                                                </div>

                                                <input type="hidden" value="<?php echo $education->meta_id ?>" name="education[id]">

                                                <div class="fre-form-btn">
                                                    <input type="submit" class="fre-normal-btn btn-submit" name="" value="<?php _e('Save', ET_DOMAIN) ?>">
                                                    <span class="fre-education-close profile-show-edit-tab-btn" data-ctn_edit="cnt-education-default-<?php echo $education->meta_id ?>"><?php _e('Cancel', ET_DOMAIN) ?></span>
                                                </div>
                                            </form>
                                        </div>
                                    </li>
