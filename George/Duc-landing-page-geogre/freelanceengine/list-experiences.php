        ...
        <div class="profile-freelance-experience">
                    ...
                    <?php if ($is_edit) { ?>
                        <div class="col-sm-6 col-xs-12">
                            <div class="freelance-experience-add">
                                <a href="javascript:void(0)" class="fre-normal-btn-o profile-show-edit-tab-btn" data-ctn_edit="ctn-edit-experience" data-ctn_hide="fre-empty-experience">
            ...
            <ul class="freelance-experience-list">
                <?php if ($is_edit) { ?>
                    ...
                    <li class="freelance-experience-new-wrap cnt-profile-hide" id="ctn-edit-experience">
                        <div class="freelance-experience-new">
                            <form class="fre-experience-form freelance-experience-form" method="post">

                                <div class="fre-input-field">
                                    <input type="text" name="work_experience[title]" placeholder="<?php _e('Title', ET_DOMAIN) ?>">
                                </div>

                                <div class="fre-input-field">
                                    <input type="text" name="work_experience[subtitle]" placeholder="<?php _e('Company', ET_DOMAIN) ?>">
                                </div>
                                ...
                                <div class="fre-input-field">
                                    <label class="fre-checkbox no-margin-bottom" for="currently-working">
                                        <input id="currently-working" type="checkbox" name="work_experience[currently_working]" value="1" class="currently-working">
                                        <span></span>
                                ...
                                <div class="fre-form-btn">
                                    <input type="submit" class="fre-normal-btn btn-submit" name="" value="<?php _e('Save', ET_DOMAIN) ?>">
                                    <span class="fre-experience-close profile-show-edit-tab-btn" data-ctn_edit="fre-empty-experience"><?php _e('Cancel', ET_DOMAIN) ?></span>
                                </div>
                            </form>
                        </div>
                    </li>
                ...
                <?php if (!empty($experiences)) {
                    foreach ($experiences as $k => $experience) {
                        if (!empty($experience->meta_value) && is_serialized($experience->meta_value)) {
                            ...
                            if (!empty($e_value)) {
                                $e_value = stripslashes_deep($e_value);
                ?>
                                <!-- Box show experience-->
                                <li class="cnt-profile-hide meta_history_item_<?php echo $experience->meta_id ?>" id="cnt-experience-default-<?php echo $experience->meta_id ?>" style="<?php echo $k + 1 == count($experiences) ? 'border-bottom: 0;padding-bottom: 0;' : '' ?>">
                                    ...
                                    <?php if ($is_edit) { ?>
                                        <div class="freelance-experience-action">
                                            <a href="javascript:void(0)" class="profile-show-edit-tab-btn" data-ctn_edit="ctn-edit-experience-<?php echo $experience->meta_id ?>">
                                ...
                                <?php if ($is_edit) { ?>
                                    <!-- Box edit experience-->
                                    <li class="freelance-experience-new-wrap cnt-profile-hide meta_history_item_<?php echo $experience->meta_id ?>" id="ctn-edit-experience-<?php echo $experience->meta_id ?>">
                                        <div class="freelance-experience-new">
                                            <form class="fre-experience-form freelance-experience-form " method="post">

                                                <div class="fre-input-field">
                                                    <input type="text" name="work_experience[title]" placeholder="<?php _e('Title', ET_DOMAIN) ?>" value="<?php echo $e_value['title'] ?>">
                                                </div>

                                                <div class="fre-input-field">
                                                    <input type="text" name="work_experience[subtitle]" value="<?php echo $e_value['subtitle'] ?>" placeholder="<?php _e('Company', ET_DOMAIN) ?>">
                                                </div>
                                                ...
                                                <div class="fre-input-field no-margin-bottom work_experience_to">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="fre-input-field novalidate_if_current">
                                                                <select class="fre-chosen-single" name="work_experience[m_to]" id="">
                                                                    <option value=""><?php _e('Month', ET_DOMAIN) ?></option>
                                                                    <?php
                                                                    for ($i = 1; $i <= 12; $i++) {
                                                                        if (intval($i) < 10) {
                                                ...
                                                <div class="fre-input-field">
                                                    <label class="fre-checkbox no-margin-bottom" for="currently-working-<?php echo $experience->meta_id ?>">
                                                        <input id="currently-working-<?php echo $experience->meta_id ?>" class="currently-working" type="checkbox" name="work_experience[currently_working]" <?php echo !empty($e_value['currently_working']) ? 'checked' : '' ?> value="1">
                                                        <span></span>
                                                        <?php _e('Currently working here', ET_DOMAIN) ?>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="fre-input-field no-margin-bottom">
                                                    <textarea name="work_experience[content]" id="" cols="30" placeholder="<?php _e('Description (optional)', ET_DOMAIN) ?>" rows="10"><?php echo !empty($e_value['content']) ? $e_value['content'] : '' ?></textarea>
                                                </div>

                                                <input type="hidden" value="<?php echo $experience->meta_id ?>" name="work_experience[id]">

                                                <div class="fre-form-btn">
                                                    <input type="submit" class="fre-normal-btn btn-submit" name="" value="<?php _e('Save', ET_DOMAIN) ?>">
                                                    <span class="fre-experience-close profile-show-edit-tab-btn" data-ctn_edit="cnt-experience-default-<?php echo $experience->meta_id ?>"><?php _e('Cancel', ET_DOMAIN) ?></span>
                                                </div>
                                            </form>
                                        </div>
                                    </li>
