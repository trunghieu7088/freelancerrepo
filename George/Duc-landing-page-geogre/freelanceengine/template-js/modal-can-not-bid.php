<?php
/**
 * Freelaner need purchase more bid to bid on this project. Submit =>  redirect to purcahse bid page.
 */
                ...
                <div class="modal-body">
    				...
    				<?php } else {
    					...
    					<?php } else {
                            ...
                            $args = array(
                                'modal_purchase_bid_label'  => __( 'You need available bid to bid this project!', ET_DOMAIN ),
                                'modal_purchase_bid_des'    => __( 'This project requires at least one avaialble bid to take bid action. You can get available bids by purchasing bids.',ET_DOMAIN ),
                                'modal_purchase_bid_btn_text' =>  __( 'Purchase Bid', ET_DOMAIN ),
                            );
                            $args = apply_filters('modal_purchase_bid',$args);
                         ?>
                            <form role="form" id="not_bid_form" class="not-bid-form fre-modal-form">
                                <h2><?php echo $args['modal_purchase_bid_label']; ?></h2>
                                <p><?php echo $args['modal_purchase_bid_des']; ?></p>
                                <div class="fre-form-btn">
                                    <input type="hidden" id="project-id" value="">
                                    <button type="submit" class="fre-normal-btn btn-submit">
    									<?php echo $args['modal_purchase_bid_btn_text']; ?>
                                    </button>
