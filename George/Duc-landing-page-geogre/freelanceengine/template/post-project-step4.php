...
<?php
    ...
    $is_free = is_post_project_free();
    if($is_free) $step--;
    if($user_ID) $step--;
?>
<div id="fre-post-project-3 step-payment" class="fre-post-project-step step-wrapper step-payment template\post-project-step4.php">
            ...
            <ul id="fre-payment-accordion" class="fre-payment-list panel-group">
                ...
                ?>
                    <li class="panel">
                        ...
                        <a data-toggle="collapse" id="paypal-button-container" data-parent="#fre-payment-accordion" href="#fre-payment-paypal" class="btn collapsed select-payment" data-type="paypal"><?php _e("Select", ET_DOMAIN); ?></a>
                    </li>
                <?php }
