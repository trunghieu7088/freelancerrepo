    ...
    <div class="portfolio-container">
        ...
        <div class="port-main-content">          
            ...
            <?php if($chosen_port_info): ?>
                        ...
                        <button data_portfolio_id="<?php echo $chosen_port_info->ID; ?>" data_delete_images_nonce="<?php echo wp_create_nonce('data_delete_images_nonce'); ?>" id="btn-delete-images-port" class="btn btn-danger edit-portfolio-btn">Delete Images <i class="fa fa-trash-o"></i></button>
