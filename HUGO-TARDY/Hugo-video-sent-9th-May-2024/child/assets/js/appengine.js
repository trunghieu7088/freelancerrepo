    ...
    */
    ...
    Views.BlockControl = Backbone.Marionette.View.extend({
        initialize: function(options) {
            ...
            //custom code recruit
            view.setupCustomFilterTomselect();
            //end
        },
        filterSkill: function() {
        ...
        loadMore: function(e) {
         ...
         //custom code recruit
         setupCustomFilterTomselect: function()
         {   
             var view=this;
    ...
    Views.SubmitPost = Backbone.Marionette.View.extend({
        ...
        submitPost: function(event) {
            event.preventDefault();
             /*custom code 5th may 2024 */
             // wait for completing uploading video
             if($("#uploading_status").val()==true || $("#uploading_status").val()=='true')
             {
                toastr.warning('Please wait for completing upload video !!');              
                return false;
             }
             /* end custom code */
            var $target = $(event.currentTarget),
             ...
             */
            /*custom code 5th may 2024 */
            view.model.set('video_attach_id',$("#video_attach_id").val())
            /*end custom code */
