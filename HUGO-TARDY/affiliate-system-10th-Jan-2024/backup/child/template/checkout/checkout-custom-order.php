...
$default_order_args = array(
    ...
    'post_title' => sprintf(__('Commande pour %s ', 'enginethemes'), $product->post_title),
    'post_content' => sprintf(__('Commande pour %s ', 'enginethemes'), $product->post_title),
...
$order_args = array(
    'post_title' => sprintf(__('Commande personnalisée pour %s ', 'enginethemes'), $product->post_title),
    'post_content' => sprintf(__('Commande personnalisée pour %s ', 'enginethemes'), $product->post_title),
...
$shipping_cost_text=mje_shorten_price($shipping_cost);
//dua shipping cost va is_ship vo js de submit len server xu ly
//neu is_ship = true tuc la co ship
$default_order_args['is_ship']='false';
$default_order_args['shipping_cost']=$shipping_cost;
$default_order_args['shipping_address']='';
...
if (!empty($custom_order_status) && in_array($custom_order_status, array('decline', 'reject', 'checkout'))) :
    $arr_custom_order_status = array(
        'decline' => __('Cette commande personnalisée à refusée.', 'enginethemes'),
        'reject' => __('Cette offre a été rejeté.', 'enginethemes'),
        'checkout' => __('Cette offre a été acceptée.', 'enginethemes'),
    );
    ...
    <div class="row order-information">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 items-chosen">
            <div class="block-items">
                <p class="title-sub"><?php _e('Personnalisé pour le service', 'enginethemes'); ?></p>
                <div class="mjob-list">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 order mjob-order-info">
            <div class="row inner">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="title-sub"><?php _e('Description sommaire', 'enginethemes'); ?></div>
            ...
            <div class="row">
                <div class="custom-offer-info">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="title-sub"><?php _e('Offre personnalisée', 'enginethemes'); ?></div>
                        <?php echo wpautop($offer['content']); ?>
                        <div class="attachment-file-name">
                            <?php echo $offer['attach_file']; ?>
                        </div>
                        <div class="time-delivery-custom">
                            <span class="title-sub"><?php _e('Délai de livraison', 'enginethemes'); ?></span>
                            <span><?php echo $offer['time_delivery']; ?> <?php echo __('jour(s)', 'enginethemes'); ?></span>
                        </div>
                    </div>
            ...
            <div class="add-extra shipping-cost-area">
                <span class="title-sub"><?php _e('Informations de livraison', 'enginethemes');?></span>
                <div class="extra-container">
                    <ul class="list-extra mjob-list-extras">
                        <li class="shipping-cost-add">
                            <div class="form-group list-item-extra">
                                <div class="packge-chose">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" value="<?php echo $shipping_cost ?>" id="shipping_cost_check" name="shipping_cost_check">
                                            <span>Veuillez expédier à l'adresse ci-dessous</span>
                                        </label>
                                    </div>
                                </div>                                
                                <div class="package-price mje-price-text">
                                    <span><span class="mje-price"><?php echo $shipping_cost_text; ?></span></span>
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="extra-container shipping-address">
                    ...
                    <p class="text-danger text-shipping-alert">Si vous souhaitez utiliser le service d'expédition, vous devez entrer l'adresse pour passer à la caisse</p>
                </div>
            </div>
            <?php endif; ?>
            <!-- end custom code -->
            ...
            <div class="float-right action-order ">
                <p>
                    <span class="total-text"><?php _e('Sous-total', 'enginethemes'); ?></span>
            ...
            <?php $commission =  (float) ae_get_option('order_commission_buyer', 0); ?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <p style="margin-bottom: 20px;"><?php printf(__('Frais de commission (%s%%) que vous devez payer pour cette commande.', 'enginethemes'), $commission); ?></p>
                        </div>
            ...
            <div class="float-right action-order">
                ...
                <button class="<?php mje_button_classes(array('btn-checkout', 'mjob-btn-checkout', 'waves-effect', 'waves-light')); ?>"><?php _e('Passer à la caisse', 'enginethemes'); ?></button>
            </div>
        </div>
    </div>
