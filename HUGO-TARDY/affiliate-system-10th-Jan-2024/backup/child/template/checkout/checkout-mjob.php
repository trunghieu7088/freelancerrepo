...
?>
    <div class="title-top-pages">
        <p class="block-title"><?php _e('Détails du paiement', 'enginethemes')?></p>
    </div>

    <div class="row order-information checkout-mjob.php">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 items-chosen">
            <div class="block-items">
                <p class="title-sub"><?php _e('Nom du service', 'enginethemes');?></p>
                <div class="mjob-list">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 order mjob-order-info">
            ...
            <div class="add-extra shipping-cost-area">
                <span class="title-sub"><?php _e('Information de livraison', 'enginethemes');?></span>
                <div class="extra-container">
            ...
            <div class="row inner other-fee-row" >
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="title-sub"><?php _e('Autres frais', 'enginethemes');?></div>
                     <div class="row">
...
<?php else: ?>
    <div class="error-block">
        <p><?php _e('Vous ne pouvez pas passer de commande pour votre propre Service', 'enginethemes');?></p>
        <p><?php printf(__('Veuillez parcourir d\'autres <a href="%s">Services</a> pour trouver le bon..', 'enginethemes'), get_post_type_archive_link('mjob_post'));?></p>
    </div>
<?php endif;?>
