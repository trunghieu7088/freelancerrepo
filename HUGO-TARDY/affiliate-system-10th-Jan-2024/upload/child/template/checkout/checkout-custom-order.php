...
//custom code for affiliate here 8th Jan 2024
if(isset($_COOKIE['affwp_ref']) && $_COOKIE['affwp_ref_visit_id'])
{
    global $wpdb;            
    $affiliate_id=$_COOKIE['affwp_ref'];   
    $default_order_args['affiliate_visit_id']=$_COOKIE['affwp_ref_visit_id'];              
                                $affiliate_info = $wpdb->get_row( "SELECT * FROM wp_affiliate_wp_affiliates WHERE affiliate_id = $affiliate_id", ARRAY_A );
     if($affiliate_info)
     {
         $user_affiliate=get_user_by('id',$affiliate_info['user_id']);
     $default_order_args['affiliate_username']=$user_affiliate->user_login;   
     }
                                ...
                                <div class="packge-chose">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <span>Please ship to the below address</span>
                                        </label>
                                    </div>
                                </div>                                
