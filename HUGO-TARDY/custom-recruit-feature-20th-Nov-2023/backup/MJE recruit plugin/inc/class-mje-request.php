...
class MJE_Request extends AE_Post_Custom{
	...
	function register_post_type(){
		$labels = array(
			'name'               => _x( 'Tender', 'post type general name', 'mje_recruit' ),
			'singular_name'      => _x( 'Tender', 'post type singular name', 'mje_recruit' ),
			'menu_name'          => _x( 'Tenders', 'admin menu', 'mje_recruit' ),
			'name_admin_bar'     => _x( 'Tenders', 'add new on admin bar', 'mje_recruit' ),
			'add_new'            => _x( 'Add New', 'Recruit', 'mje_recruit' ),
			'add_new_item'       => __( 'Add New Tender', 'mje_recruit' ),
			'new_item'           => __( 'New Tender', 'mje_recruit' ),
			'edit_item'          => __( 'Edit', 'mje_recruit' ),
			'view_item'          => __( 'View tender', 'mje_recruit' ),
			'all_items'          => __( 'All Tenders', 'mje_recruit' ),
			'search_items'       => __( 'Search tenders', 'mje_recruit' ),
			'parent_item_colon'  => __( 'Parent tender', 'mje_recruit' ),
			'not_found'          => __( 'No Tender post found.', 'mje_recruit' ),
			'not_found_in_trash' => __( 'No tender found in the trashh.', 'mje_recruit' )
		);
