...
<div id="content">
    <div class="container mjob-profile-page">
        ...
        <div class="row profile">
            ...
            <!-- custom code for social  fields -->
            <div class="col-lg-8 col-md-8 col-sm-12 col-sx-12">
                <div class="box-shadow block-profile">
                    <div class="block-billing custom-social-links-block">
                        <p class="title"><?php _e('Social Links', 'enginethemes'); ?></p>
                        <ul>

                            <li>
                                <div class="cate-title"><?php _e('Website', 'enginethemes'); ?></div>
                            ...
                            <li>
                                <div class="cate-title"><?php _e('Instagram', 'enginethemes'); ?></div>
