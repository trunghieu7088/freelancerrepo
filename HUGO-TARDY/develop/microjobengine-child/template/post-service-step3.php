...
<div class="step-wrapper step-post" id="step-post">
    <form class="post-job  post et-form" id="" >
        ...
        <!-- custom code 4th may 2024 -->
        <div class="row video-upload-area" id="video-upload-area">
        <input type="hidden" id="video_upload_nonce" name="video_upload_nonce" value="<?php echo wp_create_nonce('custom_video_upload_nonce'); ?>">                 
        <input type="hidden" id="video_attach_id" name="video_attach_id">                 
        <input type="hidden" id="uploading_status" name="uploading_status">                 
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center custom-video-upload" id="custom-video-upload">
                <a id="video-btn-upload" name="video-btn-upload" href="javascript:void(0)">
                    <i class="fa fa-video-camera"></i>
                    Video Upload
                </a>
            </div>
        </div>
        <div class="videouploadprogressBar"></div> 
        <div class="choosen-video-area">
