        ...
        Views.Revenues = Backbone.View.extend({
                ...
                var bankAccountForm = new Views.AE_Form({
                    ...
                    rules: {
                        amount: {
                            required: true,
                            digits: true,
                            min: parseInt(ae_globals.min_withdraw)
                        },
                        secure_code: 'required',
                    },
                    messages: {
                      amount: {
                          min: ae_globals.min_withdraw_error
                      }
                    },
                    type: 'withdrawMoney',
            ...
            withdrawSuccess: function(result, resp, jqXHR, type) {
                ...
                if(typeof resp.data !== "undefined") {
                    $('.revenues .freezable-text').html(resp.data.freezable_text);
                    $('.revenues .available-text').html(resp.data.available_text);
                }
