...
require_once dirname( __FILE__ ).'/fields/field-copy.php';
require_once dirname( __FILE__ ).'/fields/field-search.php';
require_once dirname( __FILE__ ).'/fields/field-select.php';
require_once dirname( __FILE__ ).'/fields/field-multi-select.php';
require_once dirname( __FILE__ ).'/fields/field-multi-input.php';
...
require_once dirname( __FILE__ ).'/fields/field-combine.php';
...
require_once dirname( __FILE__ ).'/payment/fix_paypal.php';
//WC inegrate
