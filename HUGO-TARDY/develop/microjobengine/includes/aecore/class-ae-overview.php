    ...
    function render()
    {
        ...
        foreach ($post_types as $post_type) {
            ...
            $monthly_data[] = array(
                ...
                'data' => $monthly,
                'title' => __("Overview", 'enginethemes')
            );
            ...
            $weekly_data[] = array(
                'label' => $obj->labels->name,
                'data' => $weekly,
                'title' => __("3 Months Overview", 'enginethemes')
            );
            ...
            $daily_data[] = array(
                'label' => $obj->labels->name,
                'data' => $daily,
                'title' => __("2 weeks Overview", 'enginethemes')
            );
        }
        ...
        if ($payment) {
            ...
            if (!empty($daily_payment)) {
                $daily_data[] = array(
                    'label' => sprintf(__("Revenue(%s)", 'enginethemes'), $currency),
                    'data' => $daily_payment,
                    'title' => __("Revenue", 'enginethemes')
                );
            }
...
?>
        ...
        <div class="et-main-content order-container">
