...
{
    public $args, $container, $pages, $header;
    ...
    public function print_styles()
    {
        ...
        // Add in v1.3.9.9
        $this->add_style('semantic-ui', ae_get_url() . '/open-source/semantic.css');
    }
    ...
    public function print_scripts()
    {
        ...
        // Add in v1.3.9.9
        $this->add_script('semantic-ui', ae_get_url() . '/open-source/semantic.js');
    ...
    {
        if (isset($this->args['own_frame']) && $this->args['own_frame'] == true) {
...
?>
            ...
            <!-- Admin Frame                      -->
            <!-- ================================ -->
            <div class="content-admin-setting">
...
class AE_Menu extends AE_Page
{
    ...
    function __construct($pages)
    {
        ...
        $this->args = array(
            'page_title' => __('Engine Settings', 'enginethemes'),
            'menu_title' => __('Engine Settings', 'enginethemes'),
            'cap' => 'administrator',
            'slug' => 'et-welcome',
            'icon_url' => '',
            'pos' => 3
    ...
    function upload_image()
    {
        ...
        $res = array(
            'success' => false,
            'msg' => __('There is an error occurred', 'enginethemes'),
            'code' => 400,
        );
            ...
            if (!de_check_ajax_referer($imgType . '_et_uploader', false, false) && !check_ajax_referer($imgType . '_et_uploader', false, false)) {
                ...
                if (!is_wp_error($attach_id)) {
                    ...
                    try {
                        ...
                        $res = array(
                            'success' => true,
                            'msg' => __('Branding image has been uploaded successfully', 'enginethemes'),
                            'data' => $attach_data
                        );
                    } catch (Exception $e) {
                        $res['msg'] = __('Error when updating settings.', 'enginethemes');
                    }
                } else {
                    $res['msg'] = $attach_id->get_error_message();
                }
            } else {
                $res['msg'] = __('Uploaded file not found', 'enginethemes');
            }
        }
        // send json to client
        wp_send_json($res);
    ...
    */
    ...
    public function admin_bar_menu()
    {
        ...
        $wp_admin_bar->add_menu(array(
            'id' => $parent,
            'title' => __('Site Dashboard', 'enginethemes'),
            'href' => false
        ));
