...
?>
            <span class="image-option-item <?php if ($is_selected) {
                                                echo "selected";
                                            } ?>">
                <label for="<?php echo $this->field['id'] . "_" . $key ?>">
                    <img width="150" height="150" src="<?php echo get_template_directory_uri() . $value["img"] ?>" alt="" />
                </label>
                <input id="<?php echo $this->field['id'] . "_" . $key ?>" <?php if ($is_selected) {
                                                                            echo "checked";
                                                                        } ?> type="radio" name="<?php echo $this->field['name']; ?>" value="<?php echo $key ?>">
            </span>
<?php
        }
        echo '</div>';
