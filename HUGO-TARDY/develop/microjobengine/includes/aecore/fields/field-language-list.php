...
?>
    <ul class="list-language">
      ...
      <li class="new-language">
        <button class="add-lang"><?php _e('Add a new language', 'enginethemes') ?></button>
        <div class="lang-field-wrap">
          <input id="" type="text" placeholder="<?php _e("Enter language name", 'enginethemes') ?>" name="lang_name" class="input-new-lang">
        </div>
      </li>
    </ul>
      ...
      <div class="show-new-language">
        <div class="item form no-background no-padding no-margin">
          <div class="form-item form-item-short">
            <!-- <div class="label"><?php _e("Language name", 'enginethemes') ?>:</div> -->
            <input id="new-language-name" class="bg-grey-input" type="text" placeholder="<?php _e("Enter the language's name", 'enginethemes') ?>" />
            <button id="add-new-language"><?php _e('Add language', 'enginethemes') ?><span class="icon" data-icon="+"></span></button>
            <a class="cancel" id="cancel-add-lang"><?php _e('Cancel', 'enginethemes') ?></a>
          </div>
        </div>
      </div>
    </div>
