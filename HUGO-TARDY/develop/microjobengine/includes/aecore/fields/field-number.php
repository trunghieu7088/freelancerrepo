...
class AE_number
{
    ...
    function render()
    {
        ...
        $step       = isset($this->field['step']) ? $this->field['step'] : '';
        ...
        echo '<input type="number" id="' . $this->field['id'] . '" name="' . $this->field['name'] . '" ' . $placeholder . '" step ="' . $step . '" value="' . $value . '" class="regular-text ' . $this->field['class'] . '"' . $readonly . ' /><br />';
    } //render
