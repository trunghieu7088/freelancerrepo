...
<script id="<?php echo $this->params['taxonomy'] ?>_item_form" type="text/template">
	<div class="container">
		...
		<div class="input-form input-form-1 color-default">
			...
			<?php } ?>
			<input style="color:#000;" class="bg-grey-input tax-name <?php echo $class_no_icon.' '.$class_no_color ?>" data-tax="<?php echo $this->params['taxonomy'] ?>" name="name" placeholder="<?php _e('Add a category', 'enginethemes') ?>" type="text" />
		</div>
	</div>
</script>