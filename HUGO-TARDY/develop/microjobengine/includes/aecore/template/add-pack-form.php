	...
	<div class="form payment-plan">
		...
		<div class="submit">
			<button class="btn-button engine-submit-btn add_payment_plan">
				<span><?php _e("Add badge", 'enginethemes'); ?></span><span class="icon" data-icon="+"></span>
			</button>
		</div>
	</div>
</form>