    ...
    <div class="block-page">
        <div class="container dashboard withdraw">
            <div class="row title-top-pages">
                <p class="block-title"><?php _e('MY ORDERS & TASKS', 'enginethemes'); ?></p>
                    ...
                    <div class="information-items-detail box-shadow">
                        <div class="tabs-information">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#order" aria-controls="order" role="tab" data-toggle="tab"><?php _e('My order', 'enginethemes'); ?></a></li>
