<script type="text/template" id="mjobExtraItem">
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 no-padding name-item-extra">
        <input type="text" placeholder="<?php _e('Enter the extra service description', 'enginethemes'); ?>" name="post_title" value="{{=post_title}}" class="input-items">
    </div>
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 no-padding extra-price">
        <span class="label-currency"><?php ae_currency_code(); ?></span>
        <input type="number" class="text-currency" placeholder="<?php _e('0', 'enginethemes'); ?>" name="et_budget" value="{{= et_budget}}" min="0">
    </div>
