...
<div id="content" class="mjob-order-page mjob-single-page payment-fail">
    <div class="block-page">
        <div class="container dashboard withdraw float-center">
            <p class="block-title"><?php _e('Payment Failed', 'enginethemes'); ?></p>
            <div class="checkout-payment">
                <div class="content">
                    <?php _e("You are now redirected to home page",'enginethemes');?> <br/>
                    <p class="time-leave"><?php printf(__('Time left: %s', 'enginethemes' ), '<span class="count_down">10</span>')  ?><p>
                </div>
                <?php echo '<a href="'.$permalink.'" class="btn-submit">'.__("Home page", 'enginethemes').'</a>'; ?>
            </div>
        </div>
    </div>
</div>
