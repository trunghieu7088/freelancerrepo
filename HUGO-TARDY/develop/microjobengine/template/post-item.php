...
<li class="post-item clearfix">
    ...
    <div class="info-items col-lg-8 col-md-8 col-sm-7 col-xs-12 article-post">
        <p class="author-post"><?php echo sprintf(__('Written by %s', 'enginethemes'), $current->author_name); ?></p>
        <p class="date-post"><?php echo $current->post_human_time ;?></p>
        <h2><a href="<?php echo $current->permalink ?>"><?php echo $current->post_title; ?></a></h2>
        <div class="group-function">
            <?php echo $current->post_excerpt; ?>
            <a href="<?php echo $current->permalink; ?>" class="more"><?php _e('Read more', 'enginethemes'); ?></a>
