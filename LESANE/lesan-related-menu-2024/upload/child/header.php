...
<header class="fre-header-wrapper">
    <div class="fre-header-wrap" id="main_header">
         <!-- custom code 4th April 2024 add id="custom-container" to below html element -->
        <div class="container" id="custom-container">
             <!-- end custom code 4th April 2024 -->
			...
			<div class="fre-menu-top" id="custom-html-header-menu">
				 <?php //fre_header_menu();
