...
{
    $clientID_Discord='1117083195867930685';
    $clientSecret_Discord = 'MehTAY0GfS4r4s69X2mjmmPZAeyAuzY3';
    $redirectUri_Discord ='https://jobractor.co.il/link-discord/';
    $botToken_Discord='MTExNzA4MzE5NTg2NzkzMDY4NQ.G3p7YX.B79xdHLwIn0uEoSIc0Hw9UsZEbLFnq9imaukbU';
   
    $tokenUrl_Discord = 'https://discord.com/api/v9/oauth2/token';
    $dmUrl_Discord = 'https://discord.com/api/v9/users/@me/channels';
    
    $loginDiscordLink='https://discord.com/api/oauth2/authorize?client_id=1117083195867930685&permissions=2048&redirect_uri=https%3A%2F%2Fjobractor.co.il%2Flink-discord%2F&response_type=code&scope=guilds%20identify%20bot';
