...
//custom code for suggest message
    ...
    <div class="conversation-form microjobengine\template\mjob-order\conversation.php line15">
        <div class="inner-conversation-form"><?php
                ...
                echo '</ul></div>';
                     ...
                     //custom code for realtime here
                 echo ' <div class="col-sm-12 col-md-12" id="typing-indicator" style="padding-top:10px;display:none;color:#B0B0B0;font-style: italic;" data-real-order-id="'.$mjob_order->ID.'">
                ...
                //custom code here
                 ...
                 echo '<a href="javascript:void(0);" id="show-suggested-message" style="margin-left:20px;margin-top:20px;font-size:18px;display:inline-block;"> <i class="fa fa-lightbulb-o" aria-hidden="true"></i> Suggested Message  <i class="fa fa-chevron-down"></i></a>';
                 $args_smessage = array(
                        'numberposts' => 10,
                        'post_type' =>'smessage',
                        'post_status' => 'publish',
...
(function ($) {
  $(document).ready(function () {
   ...
   $('#show-suggested-message').click(function(){
    ...
    //$('#suggested-message-list').show('slow','linear');
    //$('#suggested-message-list').fadeIn();
    //$('#suggested-message-list').slideDown('fast');
   });
