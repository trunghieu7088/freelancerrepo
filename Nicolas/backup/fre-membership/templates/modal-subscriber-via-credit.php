		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="fre-input-field">
	        		...
	        		<?php
	        		if($pack->et_price > 0){ ?>
						<label class="fre-field-title"><?php printf( __('Once you click Subscribe, your credit balance will be deducted <strong>%s</strong>.','enginethemes'), fre_price_format($price) );?></label>
						<?php
					}
