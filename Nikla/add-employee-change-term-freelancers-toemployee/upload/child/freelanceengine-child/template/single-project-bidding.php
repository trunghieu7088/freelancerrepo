...
<div id="project-detail-bidding" class="project-detail-box no-padding">
    ...
    <!-- custom code admin bid feature -->
    <?php if ( current_user_can( 'manage_options' ) ):  ?>
    <div class="row">
        <div class="col-sm-12 col-md-12">            
            <button  data-toggle="modal" data-target="#modal_bid_admin" class="btn btn-info" style="margin-top:10px;margin-left:40px;">Add Employee bid</button>            
        </div>
    </div>
    <?php endif; ?>
    <!-- end -->    
