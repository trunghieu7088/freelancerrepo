    ...
    public function login($user_data) {
        ...
        */
        ...
        if ($result && !is_wp_error($result)) {
            ...
            wp_set_auth_cookie($result->ID); // in version  1.3.9.3. fix sync login with  back-end.
	            ...
	            if(isset($do) && ( 'resetpass' === $do )) {
                    ...
                    $result = $this->insert($request);
                      //custom code here
                        ...
                        update_user_meta($result->ID,'last_name',$request['user_surname']);
                        update_user_meta($result->ID,'first_name',$request['user_name']);
                        //end
                }
                break;
