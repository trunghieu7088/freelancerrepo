...
$heading_title = '<img src="' . get_stylesheet_directory_uri() . '/assets/LOGONEWwhite2.svg" style="width: 270px; height: auto;">';
$sub_title = '<span class="custom_sub_title"><span class="yellowmark">1</span> Recruit Musical Talent /<span class="yellowmark"> 2</span> Collaborate / <span class="yellowmark">3 </span> Finish your project</span>';
?>
    <div class="slider <?php echo $has_geo_ext;?>">    
        ...
        <div class="statistic-job-number">
         ...
         <!-- custom code seynou -->  
         <div class="custom-text-icons">
                <div class="custom-text-icons-item">
                    <span>See all jobs opportunities</span>
                    <img src="<?php echo get_stylesheet_directory_uri().'/assets/arrow1.png'; ?>">
                </div>
                
                <div class="custom-text-icons-item">
                    <span>find a candidate</span>
                    <img src="<?php echo get_stylesheet_directory_uri().'/assets/arrow2.png'; ?>">
                </div>
         </div> 
         <div class="custom-area-btn">
                 <a class="btn-order waves-effect hvr-buzz-out waves-light btn-submit mjob-order-action" href="<?php echo get_post_type_archive_link('recruit'); ?>">
                    Job Opportunities                
                </a>

                <a class="btn-order waves-effect hvr-buzz-out waves-light btn-submit mjob-order-action pull-right" href="<?php echo get_post_type_archive_link('mjob_post'); ?>">
                    Talent Pool                
                </a>
        </div>

        <!-- end custom code seynou -->
       
    </div>
    <div id="content">
        <!-- custom code show video section -->
        <?php echo do_shortcode('[mje_short_video_slider_section]'); ?>
        <!-- end custom code video section -->
