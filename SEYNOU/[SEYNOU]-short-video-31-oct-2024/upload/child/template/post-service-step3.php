...
<div class="step-wrapper step-post" id="step-post">
    <form class="post-job  post et-form" id="" >
        ...
        <!-- short video 22th oct 2024 -->
        <div class="row short-video-upload-area"> 
            <label class="mb-20">Short Video</label>                         
            ...
            <input type="hidden" value="" name="choosenvideoType" id="choosenvideoType" class="input-item">              
