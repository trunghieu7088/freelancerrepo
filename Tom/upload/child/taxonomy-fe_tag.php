...
<div class="container main-center">	
	<div class="row">
        <?php 
        //custom code here    
        $current_tag = get_term_by( 'slug', get_query_var('term'), get_query_var('taxonomy') );   
        //end
        ?>
         <!-- custom code here -->
         <h1 style="margin-left:10px;"><?php echo  $current_tag->name; ?></h1>
        <p style="margin-left:15px;"><?php echo $current_tag->description; ?></p>
